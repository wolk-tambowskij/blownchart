...
import app.lawnchair.util.isDeviceAdminActive
import app.lawnchair.util.isOnePlusStock
import app.lawnchair.util.lifecycleState
import app.lawnchair.util.openUsageAccessSettings
import app.lawnchair.util.requestDeviceAdmin
        ...
        if (!LawnchairApp.isRecentsEnabled) {
            ...
            PreferenceGroup(
                ...
                val accessibilityServiceBound = remember(lifecycleState()) {
                    context.lawnchairApp.isAccessibilityServiceBound()
                }
