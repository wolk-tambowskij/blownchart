...
object BlownChartLockedStateController {

    private const val TAG = "BlownChartLockedStateController"
    ...
    private val backgroundThread: HandlerThread by lazy {
        HandlerThread("Recents-BlownChartLockedStateController", 10)
    }
    ...
    fun initialize(context: Context): BlownChartLockedStateController {
