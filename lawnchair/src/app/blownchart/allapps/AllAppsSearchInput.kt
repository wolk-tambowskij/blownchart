...
import app.blownchart.preferences2.subscribeBlocking
import app.blownchart.qsb.AssistantIconView
import app.blownchart.qsb.LawnQsbLayout.Companion.getLensIntent
import app.blownchart.qsb.LawnQsbLayout.Companion.getSearchProvider
import app.blownchart.qsb.ThemingMethod
import app.blownchart.qsb.providers.Google
import app.blownchart.qsb.providers.GoogleGo
import app.blownchart.qsb.providers.PixelSearch
import app.blownchart.qsb.setThemedIconResource
import app.blownchart.search.BlownChartRecentSuggestionProvider
import app.blownchart.search.algorithms.BlownChartSearchAlgorithm
import app.blownchart.theme.drawable.DrawableTokens
import app.blownchart.util.viewAttachedScope
