package app.blownchart.theme.color

import android.graphics.Color
import androidx.compose.ui.res.stringResource
import app.blownchart.ui.preferences.components.colorpreference.ColorPreferenceEntry
...
sealed class ColorOption {
    ...
    object WallpaperPrimary : ColorOption() {
        ...
        override val colorPreferenceEntry = ColorPreferenceEntry<ColorOption>(
            ...
            { context ->
                ...
                primaryColor ?: BlownChartBlue.color
            },
        )
    ...
    companion object {
        val BlownChartBlue = CustomColor(0xFF007FFF)
