...
import app.blownchart.theme.color.AndroidColor
import app.blownchart.theme.color.ColorOption
import app.blownchart.theme.color.ColorStyle
import app.blownchart.theme.color.MonetColorSchemeCompat
import app.blownchart.theme.color.SystemColorScheme
import app.blownchart.ui.theme.getSystemAccent
...
class ThemeProvider(private val context: Context) : SafeCloseable {
    ...
    val colorScheme get() = when (val accentColor = this.accentColor) {
        ...
        is ColorOption.WallpaperPrimary -> {
            ...
            getColorScheme(wallpaperPrimary ?: ColorOption.BlownChartBlue.color, colorStyle.style)
        }

        is ColorOption.CustomColor -> getColorScheme(accentColor.color, colorStyle.style)

        else -> getColorScheme(ColorOption.BlownChartBlue.color, colorStyle.style)
    }
