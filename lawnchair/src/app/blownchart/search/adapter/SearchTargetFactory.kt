package app.blownchart.search.adapter
...
import app.blownchart.allapps.views.SearchResultView
import app.blownchart.data.folder.service.FolderService
import app.blownchart.search.algorithms.data.Calculation
import app.blownchart.search.algorithms.data.ContactInfo
import app.blownchart.search.algorithms.data.FileInfo
import app.blownchart.search.algorithms.data.FileInfo.Companion.isImageType
import app.blownchart.search.algorithms.data.FolderInfo
import app.blownchart.search.algorithms.data.IFileInfo
import app.blownchart.search.algorithms.data.RecentKeyword
import app.blownchart.search.algorithms.data.SettingInfo
import app.blownchart.search.algorithms.engine.provider.web.WebSearchProvider
import app.blownchart.theme.color.tokens.ColorTokens
import app.blownchart.util.createTextBitmap
import app.blownchart.util.file2Uri
import app.blownchart.util.mimeCompat
