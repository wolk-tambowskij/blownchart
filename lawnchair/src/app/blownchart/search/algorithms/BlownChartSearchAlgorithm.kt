...
import app.blownchart.allapps.views.SearchItemBackground
import app.blownchart.allapps.views.SearchResultView.Companion.EXTRA_QUICK_LAUNCH
import app.blownchart.preferences2.PreferenceManager2
import app.blownchart.search.BlownChartSearchAdapterProvider
import app.blownchart.search.adapter.START_PAGE
import app.blownchart.search.adapter.SearchAdapterItem
import app.blownchart.search.adapter.SearchTargetCompat
import app.blownchart.search.adapter.SearchTargetCompat.Companion.RESULT_TYPE_APPLICATION
import app.blownchart.search.adapter.SearchTargetCompat.Companion.RESULT_TYPE_SHORTCUT
