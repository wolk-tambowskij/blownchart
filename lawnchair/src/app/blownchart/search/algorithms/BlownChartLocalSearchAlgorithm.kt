package app.blownchart.search.algorithms

import android.content.Context
import app.blownchart.preferences.PreferenceManager
import app.blownchart.preferences2.PreferenceManager2
import app.blownchart.search.adapter.SearchLinksTarget
import app.blownchart.search.adapter.SearchTargetCompat
import app.blownchart.search.adapter.SearchTargetFactory
import app.blownchart.search.algorithms.engine.ActionsSectionBuilder
import app.blownchart.search.algorithms.engine.AppsAndShortcutsSectionBuilder
import app.blownchart.search.algorithms.engine.CalculationSectionBuilder
import app.blownchart.search.algorithms.engine.ContactsSectionBuilder
import app.blownchart.search.algorithms.engine.EmptyStateSectionBuilder
import app.blownchart.search.algorithms.engine.FilesSectionBuilder
import app.blownchart.search.algorithms.engine.HistorySectionBuilder
import app.blownchart.search.algorithms.engine.SearchProvider
import app.blownchart.search.algorithms.engine.SearchResult
import app.blownchart.search.algorithms.engine.SearchSettingsSectionBuilder
import app.blownchart.search.algorithms.engine.SectionBuilder
import app.blownchart.search.algorithms.engine.SettingsSectionBuilder
import app.blownchart.search.algorithms.engine.WebSuggestionsSectionBuilder
import app.blownchart.search.algorithms.engine.provider.CalculatorSearchProvider
import app.blownchart.search.algorithms.engine.provider.ContactsSearchProvider
import app.blownchart.search.algorithms.engine.provider.FileSearchProvider
import app.blownchart.search.algorithms.engine.provider.HistorySearchProvider
import app.blownchart.search.algorithms.engine.provider.SettingsSearchProvider
import app.blownchart.search.algorithms.engine.provider.ShortcutSearchProvider
import app.blownchart.search.algorithms.engine.provider.apps.AppSearchProvider
import app.blownchart.search.algorithms.engine.provider.web.CustomWebSearchProvider
import app.blownchart.search.algorithms.engine.provider.web.WebSuggestionProvider
