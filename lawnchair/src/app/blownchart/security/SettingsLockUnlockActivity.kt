...
package app.blownchart.security
...
class SettingsLockUnlockActivity : FragmentActivity() {
    ...
    companion object {
        private const val EXTRA_SETUP_MODE = "app.blownchart.security.EXTRA_SETUP_MODE"
        private const val EXTRA_LAUNCH_INTENT = "app.blownchart.security.EXTRA_LAUNCH_INTENT"
