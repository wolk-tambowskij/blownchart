...
import app.blownchart.ui.preferences.navigation.GeneralCustomIconShapeCreator
...
fun iconShapeEntries(context: Context): List<ListPreferenceEntry<IconShape>> {
    ...
    return listOf(
        ...
        ListPreferenceEntry(IconShape.BlownChart) { stringResource(id = R.string.icon_shape_blownchart) },
    )
}
