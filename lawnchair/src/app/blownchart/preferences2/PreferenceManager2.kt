...
import app.blownchart.qsb.providers.QsbSearchProvider
...
import app.blownchart.smartspace.model.SmartspaceCalendar
import app.blownchart.smartspace.model.SmartspaceMode
import app.blownchart.smartspace.model.SmartspaceTimeFormat
...
import app.blownchart.ui.popup.toOptionOrderString
import app.blownchart.ui.preferences.components.HiddenAppsInSearch
...
class PreferenceManager2 private constructor(private val context: Context) :
    ...
    /** Salted PBKDF2 hash of the settings-lock PIN (see [app.blownchart.security.PinHasher]); never the raw PIN. */
