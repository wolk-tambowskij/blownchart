...
import app.blownchart.util.EditTextExtensions;
...
public class Folder extends AbstractFloatingView implements ClipPathView, DragSource,
    ...
    protected void onFinishInflate() {
        ...
        var alpha = BlownChartUtilsKt.getFolderBackgroundAlpha(getContext());
     ...
     * entirely through app.blownchart.data.folder's own Room database, whose ids come from a
